...
### Project Links
```
Weights & Biases project link: https://wandb.ai/abdelkarim-eljandoubi/nyc_airbnb?workspace=user-
Github repository link: https://github.com/eljandoubi/build-ml-pipeline-for-short-term-rental-prices
```
